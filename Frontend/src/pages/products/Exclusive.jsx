...
export default function Exclusive() {
  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
          ...
          <div className="w-full lg:w-2/3 flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left w-full md:max-w-md">
              <h2 className="text-xl lg:text-2xl font-semibold">Exclusive GeoCityDatabase</h2>
              <h1 className="text-3xl lg:text-4xl font-bold text-blue-600">$499.99</h1>
              <p className="my-4 text-gray-700 text-sm lg:text-base">
                ...
                list of cities name, state/province (ADM1), country code.
              </p>
      ...
      {/* I've kept the commented sections in case you want to add them back later */}
    </>
  );
}
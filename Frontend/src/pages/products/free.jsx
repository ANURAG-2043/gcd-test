    ...
    <>
      ...
      <section className="mt-16 lg:mt-20 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <section className="adv mb-8 lg:mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mx-auto max-w-3xl text-sm lg:text-base">
          ...
          <section className="req mb-8 lg:mb-12">
            <h2 className="text-xl font-semibold mb-4 text-center lg:ml-[280px] lg:text-left">Requirements</h2>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mx-auto max-w-3xl text-sm lg:text-base">
          ...
          <section className="spec mb-8 lg:mb-12">
            <h2 className="text-xl font-semibold mb-4 text-center">Specifications</h2>
            <div className="overflow-x-auto">
              <table className="table-auto border-collapse border border-black w-full mx-auto max-w-4xl text-sm lg:text-base">
                <thead>
                  <tr>
      ...
      <section className="sql mb-8 lg:mb-12">
        ...
        <div className="space-y-8">
          <div className="step">
            <img src={s1} alt="Step 1" className="w-[90%] lg:w-3/4 mx-auto h-auto" />
            <h2 className="text-base lg:text-lg mt-2 text-center">Step 1</h2>
          </div>
          <div className="step">
            <img src={s2} alt="Step 2" className="w-[90%] lg:w-3/4 mx-auto h-auto" />
            <h2 className="text-base lg:text-lg mt-2 text-center">Step 2</h2>
          </div>
          <div className="step">
            <img src={s3} alt="Step 3" className="w-[90%] lg:w-3/4 mx-auto h-auto" />
            <h2 className="text-base lg:text-lg mt-2 text-center">Step 3</h2>
          </div>
          <div className="step">
            <img src={s4} alt="Step 4" className="w-[90%] lg:w-3/4 mx-auto h-auto" />
            <h2 className="text-base lg:text-lg mt-2 text-center">Step 4</h2>
          </div>
        </div>
      </section>

      <section className="license mb-8 lg:mb-12 px-4 lg:px-8">
        <h2 className="text-xl font-semibold mb-4 text-center">Licensing</h2>
        <p className="text-gray-700 font-bold text-center text-sm lg:text-base">Single Server License</p>
        <p className="text-gray-700 px-4 lg:px-20 text-center text-sm lg:text-base">

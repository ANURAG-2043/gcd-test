        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
          <div className="flex justify-center w-full lg:w-auto">
            <img
              ...
              className="w-full max-w-[250px] lg:max-w-[600px] h-auto object-contain"
            />
          </div>
          <div className="text-center lg:text-left w-full lg:w-1/2">
            <h2 className="text-xl lg:text-2xl font-semibold">Cities ZIPCode Database</h2>
            <h1 className="text-3xl lg:text-4xl font-bold text-blue-600">$299.99</h1>
